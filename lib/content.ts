    ...
    sections: {
      ...
      oncology: {
        ...
        cards: [
          ...
          { title: "CLDN18.2 CAR-T pathway communication", text: "For eligible CLDN18.2-positive gastric cancer patients, we can help coordinate communication with experienced clinical teams in China and support evaluation preparation." },
        ...
        note:
          "We do not provide treatment, determine eligibility, promise clinical trial enrollment, or promise access to any therapy. We help patients prepare, coordinate, and communicate.",
      },
      mdt: {
    ...
    sections: {
      ...
      oncology: {
        ...
        cards: [
          ...
          { title: "CLDN18.2 CAR-T 路徑溝通", text: "對部分符合條件的 CLDN18.2 陽性胃癌患者，可協助對接中國有經驗的臨床團隊，支持前沿治療路徑評估準備。" },
        ...
        note: "我們不提供治療、不判定入選資格、不保證臨床研究入組，也不承諾任何療法可及性。我們協助患者準備、協調和溝通。",
      },
      mdt: {
        eyebrow: "廣東腫瘤專家資源",
    ...
    sections: {
      ...
      oncology: {
        ...
        cards: [
          ...
          { title: "CLDN18.2 CAR-T", text: "Для подходящих CLDN18.2-позитивных пациентов с раком желудка мы помогаем с коммуникацией и подготовкой к оценке." },
        ...
        note: "Мы не лечим, не определяем право на терапию, не гарантируем включение в исследование и не обещаем доступ к лечению.",
      },
      mdt: {
    ...
    sections: {
      ...
      oncology: {
        ...
        cards: [
          ...
          { title: "مسار CLDN18.2 CAR-T", text: "للمرضى المناسبين بسرطان معدة CLDN18.2-positive، نساعد في التواصل والتحضير للتقييم." },
        ...
        note: "لا نقدم علاجا، ولا نحدد الأهلية، ولا نضمن دخول تجربة سريرية، ولا نعد بإتاحة أي علاج.",
      },
      mdt: {
    ...
    sections: {
      ...
      oncology: {
        ...
        cards: [
          ...
          { title: "Komunikasi jalur CLDN18.2 CAR-T", text: "Untuk pasien kanker lambung CLDN18.2-positive yang sesuai, kami membantu komunikasi dan persiapan evaluasi di China." },
        ...
        note: "Kami tidak memberi terapi, menentukan kelayakan, menjamin masuk clinical trial, atau menjanjikan akses terhadap terapi apa pun.",
      },
      mdt: {
    ...
    sections: {
      ...
      oncology: {
        ...
        cards: [
          ...
          { title: "Komunikasi laluan CLDN18.2 CAR-T", text: "Untuk pesakit kanser gastrik CLDN18.2-positive yang sesuai, kami membantu komunikasi dan persediaan penilaian di China." },
        ...
        note: "Kami tidak memberi rawatan, menentukan kelayakan, menjamin kemasukan clinical trial, atau menjanjikan akses kepada mana-mana terapi.",
      },
      mdt: {
